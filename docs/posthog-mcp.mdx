...
This is distinct from the [PostHog bounce-rate REST client](/posthog), which queries session bounce rates in your PostHog project via HogQL. Use MCP when you want the agent to explore PostHog data directly during investigations.
